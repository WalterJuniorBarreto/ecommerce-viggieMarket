        ...
        <div class="notification-slider">
            <div>
                <div class="timer-notification text-center">
                    <h6>
                        <strong class="me-1">¡Bienvenido a ViggieMarket!</strong>
                ...
                <div class="col-12">
                    <div class="navbar-top">
                        ...
                        <a href="{{ route('home') }}" class="web-logo nav-logo">
                            <img src="{{ asset('assets/images/logo/andercode.png') }}" class="img-fluid blur-up lazyload" alt="" style="width: 75px;">
                        </a>
